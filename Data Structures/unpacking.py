...
# we can also unpack dictionaries, but we have to use **

dict_1 = {"a": 1, "b": 2}
dict_2 = {"b": 4, "c": 6}
combined_dict = {**dict_1, **dict_2}  # If we have multiple values with the same key the last value will be used
print(combined_dict)
