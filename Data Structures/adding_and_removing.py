...
# first argument position of the list, second argument iem to add
letters.insert(2, "-")
print(letters)
...
# with an argument it removes the item with that index
letters.pop(2)
print(letters)
...
# we this statement we can remove one item or a range of items by their index
del letters[0:2]
print(letters)
