...
p1 = Point(1, 2, 3)
p2 = Point(1, 2, 3)
# print(p1 == p2) # But when using this, it will return False, because the two objects are stored in different
# locations of the memory print(id(p1)) # To see where they are stored in memory use the "id()" functions that returns
# memory address. print(id(p2))
...
Point_t = namedtuple("Point", ['x', "y",
                               "z"])
# The first argument we specify the label for the new type we want to
# create. The second argument we pass an array of field names or attribute names.
